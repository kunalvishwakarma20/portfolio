      ...
      <style>
        {`
          ...
          @keyframes stepPulse {
            0% {
              transform: scale(1);
              box-shadow: 0 0 0 0 rgba(23, 37, 209, 0.4);
            }
            50% {
              transform: scale(1.15);
              box-shadow: 0 0 0 8px rgba(23, 37, 209, 0);
            }
            100% {
              transform: scale(1);
              box-shadow: 0 0 0 0 rgba(23, 37, 209, 0);
            }
          }
          
          .timeline-glow-line {
            box-shadow: 0 0 12px rgba(23, 37, 209, 0.3),
                        0 0 24px rgba(59, 77, 240, 0.2),
                        0 0 36px rgba(23, 37, 209, 0.1);
            filter: blur(0.5px);
          }
      ...
      <div ref={ref} className="relative pb-20">
          ...
          return (
            ...
            >
              <div className="sticky z-40 flex flex-col items-center self-start max-w-xs md:flex-row top-40 lg:max-w-sm md:w-full">
                ...
                >
                  <motion.div 
                    className="w-4 h-4 p-2 border-2 rounded-full bg-neutral-800 border-blue-500/60"
                    style={{
                      boxShadow: useTransform(
                        currentStepProgress,
                        [0, 1],
                        [
                          "0 0 0px rgba(23, 37, 209, 0)",
                          "0 0 8px rgba(23, 37, 209, 0.5), 0 0 16px rgba(59, 77, 240, 0.3)"
                        ],
                        { clamp: true }
                      ),
                    }}
        ...
        >
          <motion.div
            ...
            className="timeline-glow-line absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t from-blue-500/90 via-blue-400/70 via-lavender/60 to-transparent from-[0%] via-[15%] rounded-full"
            transition={{
              type: "spring",
              stiffness: 200,
              damping: 30
          ...
          <motion.div
            ...
            className="timeline-glow-blur absolute inset-x-0 top-0 w-[4px] -left-1 bg-gradient-to-t from-blue-500/25 via-lavender/15 to-transparent rounded-full"
            transition={{
              type: "spring",
              stiffness: 200,
              damping: 30
